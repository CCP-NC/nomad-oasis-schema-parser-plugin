# nomad-oasis-schema-parser-plugin

Specialised magres parser + custom schema package for the CCP-NC NOMAD Oasis.
...
```sh
git clone https://github.com/CCP-NC/nomad-oasis-schema-parser-plugin.git
cd nomad-oasis-schema-parser-plugin
